...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50">
      {/* Hero Section */}
      <section 
  className="bg-cover bg-center text-black py-24 h-[60vh] relative flex items-center justify-center mt-10"
  style={{ backgroundImage: "url('./images/bg2.jpg')" }}
>
  <div className="container mx-auto px-2 relative h-screen sm:h-[60vh] flex flex-col justify-center text-left">
    <div 
      className="absolute bottom-20 sm:bottom-0 w-full flex flex-col items-start"
      style={{ transform: 'translateY(-100%)' }} // Adjust the height placement
    >
      <h1 className="text-3xl sm:text-5xl font-bold mb-2 fade-in text-green-700 font-serif">
        Welcome to <span className="text-yellow-500">LBSSN</span>
      </h1>
